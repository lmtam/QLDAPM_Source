...
//    }
    public function getDetail($MaDuLieu){
        ...
        $this->data['title']  = $this->data['dulieu']->TenDiaDiem .' - myfinder.96.lt';
        ...
        $this->data['ratingPoint'] = $rating_model->RatingPoint($MaDuLieu);
        $this->data['totalRating'] = $rating_model->totalRating($MaDuLieu);
