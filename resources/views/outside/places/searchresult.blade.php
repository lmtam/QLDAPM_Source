                    ...
                    <ul class="recommendationList">
                        ...
                        <li class="card singleRecommendation hasPhoto tipWithLogging" onmousemove="clickFunc('{!! $item->dulieu->MaDuLieu !!}')">
                                ...
                                <div class="contentHolder">
                                        ...
                                        <div class="venueBlock">
                                            <div class="venueDetails">
                                                <div class="venueName">
                                                    ...
                                                    <div class="venueScore positive" title="" style="background-color: #73CF42;">{{$item->pointRating}}
                                                    </div>
                                                    <div class="venueAddressData">
                                                        ...
                                                        <div class="venueData">
                                                        <input  id="diachi-{{ $i }}" value="{{ $item->dulieu->SoNha . ' Đường '. $item->duong->TenDuong. ' Phuong '. $item->phuong->TenPhuong. ' Quận '. $item->quanhuyen->TenQuanHuyen}}" hidden="true">
                                                        <input  id="tendiadiem-{{ $i }}" value="{{$item->diadiem->TenDiaDiem}}" hidden="true">
                                    ...
                                    <input id="hinhdaidien-{{$i}}" value="{{ $path}}" hidden=true>
                                </div>
                                <?php $i++;?>
                        ...
                        <li class="card fewResults">
                            <h4>Chỉ có  {{ count($result) }} kết quả? Hãy thử..</h4>
                            <ul class="suggestions"><li class="zoomSuggestion">
                    <span class="link" data-action="zoomOut1">Zoom ra ngoài
                    </span>
                                    để tìm kiếm một khu vực lớn hơn.</li><li>Hoặc tìm kiếm nhiều thông tin hơn (như <span class="link"
                                                                                                                     data-action="category"
                                                                                                                     data-value="food">Quán ăn</span>,
                                    <span class="link" data-action="category" data-value="coffee">Cà phê</span>, or <span class="link" data-action="category"
                                                                                                                          data-value="drinks">Atm</span>)
                                </li>
...
//
                contentString = new Array();
                    ...
                    for(var i = 1;i<=countplace; i++){
                        ...
                        diadiem.push(a);
                        var strTendiadiem = $('#tendiadiem-'+i).val();
                        var strDiachi = $('#diachi-'+i).val();
                        var hinhdaidien = $('#hinhdaidien-'+i).val();
                        var temp  = '<table bordercolor="#2d5be3"><tr><td height="42" width="42" rowspan="2" background="'+hinhdaidien+'" style="background-size: 100% 100%;  "></td><td colspan="2" style="padding-left:10px;"><a href="#" style="color: #2d5be3; "><strong>'+ strTendiadiem +'</strong></a></td></tr><tr><td style="padding-left:10px;"><strong>'+ strDiachi +'</strong></td></tr><tr><td align="center" bgcolor="#999999">1</td><td style="padding-left:10px;" ><font ><strong>Vị trí - Giá Tiền</strong></font></td></tr> </table>';
                        //console.log(temp);
                        contentString.push(temp);
                    }
//                    diadiem.push(pyrmont);
//                    diadiem.push(khtn);
...
//                    var image = "xxx.jpg";
            ...
            //contentString[0] = '<table bordercolor="#0000CC"><tr><td height="42" width="42" rowspan="2" background="do an.png" style="background-size: 100% 100%;"></td><td colspan="2"><a href="#">Quan An Quan 8 Day</a></td></tr><tr></td><td>Địa chỉ quán</td></tr><tr><td align="center" bgcolor="#999999">1</td><td >Vị trí - Giá Tiền</td></tr> </table>';
            //contentString[1] = "xyz";
